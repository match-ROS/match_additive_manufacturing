...
class ROSGui(QWidget):
    ...
    def __init__(self):
        ...
        # Override
        override_layout = QVBoxLayout(); override_label = QLabel("Override (%)"); self.override_slider = QSlider(Qt.Horizontal); self.override_slider.setRange(0,100); self.override_slider.setValue(100); self.override_slider.setTickInterval(10); self.override_slider.setTickPosition(QSlider.TicksBelow); self.override_value_label = QLabel("100%"); self.ros_interface.init_override_velocity_slider(); override_layout.addWidget(override_label); override_layout.addWidget(self.override_slider); override_layout.addWidget(self.override_value_label); left_layout.addLayout(override_layout)
